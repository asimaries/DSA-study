...
void solve()
{
	...
	/* Nodes when constructor is declared in Node */
	Node *head = new Node(2);
	Node *second = new Node(7);
	Node *third = new Node(23);

	/* Initializing the data of Nodes when constructor is not declare */
	head->data = 76;
	second->data = 48;
	third->data = 6;

	/* Inputs in data of Nodes */
	cin >> head->data;
	cin >> second->data;
	cin >> third->data;

	/* Linking of Nodes one-by-one */
	head->next = second;
	second->next = third;
	third->next = NULL;
	...
	cout << endl
		 << "No. of elements in Linked List is: " << count;
	...
	cout << endl
		 << "Middle element of Linked List is: " << midElement(head);
	...
	pushKth(head, 0, 2);
	cout << endl
		 << "Linked List after inserting Nth Node: ";
	printList(head);

	popKth(head, 4);
	cout << endl
		 << "Linked List after deleting Nth Node: ";
	printList(head);
...
/* 
	Test data set for Linked List

	Node *head  = new Node(05);
	Node *second = new Node(02);
	Node *third = new Node(06);
	Node *four = new Node(28);
	Node *five = new Node(34);
	Node *six = new Node(48);
	Node *seven = new Node(57);
	Node *eight = new Node(97);
	Node *nine = new Node(32);
	Node *ten = new Node(16);
	Node *eleven = new Node(04);
	Node *twelve = new Node(47);
